$(window).on("load", function() {
    ...
    var porcentagem = document.getElementById("support-tracker-chart").getAttribute("data-porcentagem");
    var plano = document.getElementById("support-tracker-chart").getAttribute("data-plano");
    var l = {
        chart: {
            height: 270,
            type: "radialBar"
    ...
    var ativos = parseInt(document.getElementById("indicadosativos").innerHTML);
    var pendentes = parseInt(document.getElementById("indicadospendentes").innerHTML);
    var indicadosativos = ativos / (ativos + pendentes)* 100;
    var indicadospendentes = pendentes / (ativos + pendentes)* 100;
    var d = {
        chart: {
            height: 325,
            type: "radialBar"
        ...
        series: [indicadospendentes, indicadosativos],
        labels: ["Pendentes", "Ativos"]
    };
