...
class Ticketmodel extends CI_Model{
    ...
    public function AbrirTicket(){
        ...
        if($criaTicket){
            ...
            $this->session->set_userdata('message_ticket', '<div class="alert alert-success text-center">Ticket criado com sucesso!</div>');
    ...
    public function DadosTicket($id_ticket){
        ...
        if($ticket->num_rows() > 0){
            ...
            $this->session->set_userdata('message_show_tickets', '<div class="alert alert-danger text-center">Ação não permitida!</div>');
            redirect('ticket');
        }
    ...
    public function ResponderTicket($id_ticket){
        ...
        if($ticket->num_rows() > 0){
            ...
            return '<div class="alert alert-danger text-center">Desculpe, mas o ticket foi fechado e por esse motivo, você não pode responder.</div>';
        }
        ...
        if($update){
            ...
            if($insert){
                ...
                return '<div class="alert alert-success text-center">Ticket respondido com sucesso!</div>';
            }
        }

        return '<div class="alert alert-danger text-center">Erro ao responder seu ticket. Por favor, tente novamente.</div>';
    }
