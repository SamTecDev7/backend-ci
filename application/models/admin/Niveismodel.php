...
class Niveismodel extends CI_Model{
    ...
    public function NovoNivel(){
        ...
        if($insert){
            ...
            return '<div class="alert alert-success text-center">Nível adicionado com sucesso!</div>';
        }

        return '<div class="alert alert-danger text-center">Erro ao adicionar nível. Tente novamente.</div>';
    }
    ...
    public function EditarNivel($id){
        ...
        if($update){
            ...
            return '<div class="alert alert-success text-center">Nível atualizado com sucesso!</div>';
        }

        return '<div class="alert alert-danger text-center">Erro ao atualizar nível. Tente novamente.</div>';
    }
