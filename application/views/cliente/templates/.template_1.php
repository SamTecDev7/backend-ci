...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="danger" style="background: linear-gradient(to right, #a3005c, #1d1d51); border: none; border-radius: 10px;">
      <!--
        ...
        <ul class="nav">
          <li class="nav-item">
            ...
            <a class="nav-link" data-toggle="collapse" href="#cursos">
              ...
              <p> <font color="white">Life Store</font>
                <b class="caret"></b>
              </p>
            </a>
              ...
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('ativos');?>">
                    <span class="sidebar-mini"><font color="white"><font color="white"><font color="white"><font color="white"><font color="white"><font color="white"> IA </span>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('pendentes');?>">
                    <span class="sidebar-mini"><font color="white"><font color="white"><font color="white"><font color="white"> IP </span>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('linear');?>">
                    <span class="sidebar-mini"><font color="white"><font color="white"><font color="white"><font color="white"> RL </span>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('pontos/extrato');?>">
                    <span class="sidebar-mini"><font color="white"><font color="white"><font color="white"><font color="white"> EP </span>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('carreira');?>">
                    <span class="sidebar-mini"> <font color="white"><font color="white">PC </span>
              ...
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('faturas');?>">
                    <span class="sidebar-mini"> <font color="white"><font color="white"><font color="white"><font color="white"><font color="white"><font color="white"><font color="white">F </span>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('saque');?>">
                    <span class="sidebar-mini"> <font color="white"><font color="white"><font color="white"><font color="white"><font color="white">S</span>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('transferencia');?>">
                    <span class="sidebar-mini"> <font color="white"><font color="white"><font color="white"><font color="white"><font color="white">TU</span>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('extrato');?>">
                    <span class="sidebar-mini"><font color="white"><font color="white"><font color="white"><font color="white"> E </span>
