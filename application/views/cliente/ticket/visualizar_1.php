<div class="row">
    ...
    <div class="col-md-10">
        ...
        <ul class="timeline timeline-simple">
            <?php if($mensagens !== false){ foreach($mensagens as $mensagem){ ?>
            <li class="timeline-inverted">

                <?php if ($mensagem->respondido_por == 1): ?>
                ...
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        <span class="badge badge-pill badge-<?php echo ($mensagem->respondido_por == 1) ? 'success' : 'danger'; ?>"><?php echo ($mensagem->respondido_por == 1) ? 'Você' : 'Suporte'; ?></span>
                    </div>
                    ...
                    <h6>
                      <i class="ti-time"></i> <?php echo date('d/m/Y H:i:s', strtotime($mensagem->data));?>
                    </h6>
                </div>
            </li>
            <?php } } ?>
