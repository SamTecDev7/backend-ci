...
<nav class="navbar navbar-toggleable-md sign-in-header">
  ...
  <div class="sidebar-right pull-right" >
    <ul class="navbar-nav  justify-content-end">
      <li><a href="#" class="btn btn-link text-white" >Precisa de ajuda?</a></li>
      <li><a href="<?php echo base_url('cadastrar');?>" class="btn btn-primary " >Cadastre-se</a></li>
    </ul>
  </div>
</nav>
</header>
<div class="wrapper-content-sign-in p-0">
  <div class="col-md-8 offset-md-8 text-left side_signing_full">
      <form class="form-signin1 full_side text-white" action="<?php echo base_url('login');?>" method="POST">
      ...
      <br>
      <p class="mt-3">
          <a href="<?php echo base_url('cadastrar');?>" class="text-white">Quer uma conta?</a> 
          <br>
        <a href="<?php echo base_url('recuperar');?>" class="">Perdi minha senha</a>
      </p>
    </form>
    <br>
  </div>
