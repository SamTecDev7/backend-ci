              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header card-header-icon card-header-success">
                    <h4 class="card-title ">Saque (R$ <?php echo number_format(InformacoesUsuario('saldo'), 2, ",", ".");?>)</h4>

                    <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#new_mibank"><i class="fa fa-dollar"></i> Cadastrar conta Urpay</button>
                     <?php
                            if(true){
                        ?>
                  </div>
                  <div class="card-body">
                   <p class="text-center alert alert-success">Para solicitar o saque, informe os campos abaixo. Lembrando que o valor mínimo para saque de rendimento é de <b>R$ <?php echo number_format(ConfiguracoesSistema('valor_minimo_saque'), 2, ",", ".");?></b>. Será descontada a taxa de <b><?php echo ConfiguracoesSistema('taxa_saque');?>%</b> sobre o saque. Após solicitar o saque, você poderá visualizar o desconto em seu extrato.</p>

                    <form class="form-horizontal form-variance">
                    <input class="form-check-input" type="checkbox" name="tipo_saque" id="tipo_saque" value="1" checked="">
                    <input class="form-check-input" type="checkbox" name="tipo_saque" id="tipo_saque" value="2">
...
<div class="form-check">
                          ...
                          <label class="form-check-label">
                              <input class="form-check-input" type="radio" name="local_recebimento" id="local_recebimento" value="3" checked="">
                            <b>Urpay</b>
                            <span class="circle">
                              <span class="check"></span>
                            </span>
...
<?php if ($saquerendimento == true): ?>

                        </p>
                <label class="text-center col-sm-12 control-label">É preciso um plano ativo a mais de 15 dias úteis para sacar seus rendimentos</label>
            <hr>
        <?php endif; ?>
